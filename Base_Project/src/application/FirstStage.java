...
public class FirstStage extends Main {
	...
	static ImageView imv = new ImageView(new Image("file:Base_Project/Image/imag.jpg"));
	static ImageView imv2 = imv;
	Circle clip;
	FileChooser chosen = new FileChooser();
	File test = new File("Base_Project/file.rtf");
	File file, imageFile;
	...
	public FirstStage() throws Exception { // Constructor
		...
		Image image = new Image("file:Base_Project/Image/back.png");
		...
		bd.setStyle("-fx-background-image:url('file:Base_Project/Image/img.png');-fx-background-size:cover");
		back.setStyle(
		...
		hbox2.setAlignment(Pos.CENTER);// not used
		vbox.setAlignment(Pos.CENTER);
		vbox.getChildren().addAll(hbox1, hbox2);
		bd.setBottom(vbox);

//		Path image = Paths.get("/Users/Ameer/eclipse-workspace/Base_Project/src/dr.jpeg");
...
//		pstatement.executeUpdate();
	...
	private SplitPane DentistManagementInterface() { // Dentist Management
		...
		border.setStyle("-fx-background-image:url('file:Base_Project/Image/basicPage.jpg');-fx-background-size:cover");
		vbox.setStyle("-fx-background-image:url('file:Base_Project/Image/basicPage.jpg');-fx-background-size:cover");
		border.setCenter(new ImageView(new Image("file:Base_Project/Image/logo2.png")));
		...
		save.setOnAction(e -> {
			...
			try {
				...
				// we looped in set to get max id(last added)
		...
		delete.setOnAction(e -> {
			...
			alert1.setTitle("Delete Dentist Account");
			alert1.setHeaderText("Are you sure ?");
			alert1.setContentText("This action is UnChangable!!");
	...
	private SplitPane PatientManagementInterface() { // Patient Management
		...
		prev.setFont(font);
		border.setCenter(new ImageView(new Image("file:Base_Project/Image/logo.png")));
		vbox.setAlignment(Pos.CENTER);
	...
	private SplitPane paymentManagementInterface() { // Payment Interface
		...
		split.setDividerPositions(0.22);
		bd.setCenter(intro);
		bd.setStyle("-fx-background-image:url('file:Base_Project/Image/basicPage.jpg');-fx-background-size:cover");
		add.setStyle(
				"-fx-background-radius: 40 40 40 40;-fx-background-color: lightblue; -fx-text-fill: black; -fx-font-size: 16px; -fx-padding: 10px 30px;");
		delete.setStyle(
				"-fx-background-radius: 40 40 40 40;-fx-background-color: lightblue; -fx-text-fill: black; -fx-font-size: 16px; -fx-padding: 10px 30px;");
...
//		bd.setBottom(book);
	...
	private BorderPane DoctorLogIn() throws Exception { // Log in interface for (Doctor).
		...
		border.setPadding(new Insets(20, 20, 20, 20));
		border.setStyle("-fx-background-image:url('file:Base_Project/Image/login.jpg');-fx-background-size:cover");
		border.setTop(back);
	...
	private void restoringForAdminstrator() { // Restore the admin's password by his email
		...
		vbox.setAlignment(Pos.CENTER);
		hbox.setAlignment(Pos.CENTER);
		border.setStyle("-fx-background-image:url('file:Base_Project/Image/restore.jpg');-fx-background-size:cover");
	...
	private BorderPane restoringForDentists() { // Restore UserName and Password For Dentists
		...
		gp.setAlignment(Pos.CENTER);
		border.setPadding(new Insets(20, 20, 20, 20));
		border.setStyle("-fx-background-image:url('file:Base_Project/Image/img4.jpg');-fx-background-size:cover");
		prev.setStyle(
				"-fx-background-radius: 25 25 25 25;-fx-background-color: d8d9e0; -fx-text-fill: black; -fx-font-size: 16px; -fx-padding: 10px 30px;");
...
//		GridPane.setHalignment(restore, HPos.LEFT);
	...
	public void eventsForBasicButtons() { // For handling the styles events
		...
		back.setOnMouseEntered(e -> {
			back.setImage(new Image("file:Base_Project/Image/back2.png"));
		});
		back.setOnMouseExited(e -> {
			back.setImage(new Image("file:Base_Project/Image/back.png"));
		});
